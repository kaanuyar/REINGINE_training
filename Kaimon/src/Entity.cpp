...
Entity::Entity(RawEntity& rawEntity, Vector3f worldTranslation, Vector3f worldRotation, Vector3f worldScale)
	: m_rawEntity(rawEntity), m_translationVector(worldTranslation), m_rotationVector(worldRotation), m_scaleVector(worldScale)
{
}
