...
Game::Game()
	...
	m_target(m_rawEntity, Vector3f(0.0f, 0.0f, -5.0f), Vector3f(0.0f, 0.0f, 0.0f), Vector3f(0.25f, 3.0f, 0.25f)),
	...
	m_barrier(m_rawEntity, Vector3f(0.0f, 0.0f, -3.0f), Vector3f(0.0f, 0.0f, 0.0f), Vector3f(7.0f, 1.0f, 0.25f)),
